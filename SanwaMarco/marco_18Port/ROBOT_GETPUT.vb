Function RobotGetPut();
	...
	SETVAR("@point",DECODE("@<arg2>","BF11","0011","BF12","0012","BF13","0013","BF14","0014","BF15","0015","@<point>"));
	SETVAR("@point",DECODE("@<arg2>","BF21","0021","BF22","0022","BF23","0023","BF24","0024","BF25","0025","@<point>"));
	SETVAR("@point",DECODE("@<arg2>","BF31","0031","BF32","0032","BF33","0033","BF34","0034","@<point>"));
	SETVAR("@point",DECODE("@<arg2>","BF41","0041","BF42","0042","BF43","0043","BF44","0044","@<point>"));
	RETURN("point_unknow,@<arg2>","'@<point>' = 'undefined'");
	
	'檢查目的地在席 io Sensor
	SETVAR("@io", DECODE("@<arg2>", "P1", 101;102;103;108;109;110;104;105;106;107, "P2", 201;202;203;111;112;113;204;205;206;207, "P3", 301;302;303;305, "P4", 309;310;311;313, "@<io>"));
	SETVAR("@io",DECODE("@<arg2>","BF11",500;501,"BF12",504;505,"BF13",508;509,"BF14",512;513,"BF15",808;809,"@<io>"));
	SETVAR("@io",DECODE("@<arg2>","BF21",502;503,"BF22",506;507,"BF23",510;511,"BF24",514;515,"BF25",810;811,"@<io>"));
	SETVAR("@io",DECODE("@<arg2>","BF31",600;601,"BF32",604;605,"BF33",608;609,"BF34",812;813,"@<io>"));
	SETVAR("@io",DECODE("@<arg2>","BF41",602;603,"BF42",606;607,"BF43",610;611,"BF44",814;815,"@<io>"));
	RETURN("sensor_unknow,@<arg2>","'@<io>' = 'undefined'");
	'檢查實際IO
	SETVAR("@interval", "200");
